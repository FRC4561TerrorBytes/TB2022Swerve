...
import frc.robot.subsystems.ShooterSubsystem.FlywheelHoodSetpoint;
/**
...
public final class Constants {
        ...
        public static final List<Entry<Double, FlywheelHoodSetpoint>> SHOOTER_VISION_MAP = Arrays.asList(
        Map.entry(0.00, new FlywheelHoodSetpoint(2000.0, 30.0))
        );
}
