...
public final class Constants {
  ...
  public static final double TURRET_LOWER_LIMIT = 0;
  public static final double TURRET_UPPER_LIMIT = 0;
  public static final boolean TURRET_ENABLE_SOFT_LIMITS = false;
